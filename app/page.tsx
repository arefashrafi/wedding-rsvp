  ...
  return (
    <>
      <div className='relative z-10 text-center space-y-8 px-4 pt-16 min-h-screen flex flex-col items-center justify-center'>
        <TextGenerateEffect
          className='text-6xl md:text-8xl font-bold text-gray-900 font-playfair italic'
          duration={0.75}
          words='Sueun & Aref'
        />
        <TextGenerateEffect className='text-xl md:text-2xl text-gray-600' duration={1} words="We're getting married!" />
        <button
